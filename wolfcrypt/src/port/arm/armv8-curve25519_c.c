...
void ge_add(ge_p1p1 r, const ge_p3 p, const fe qe_cached)
{
    __asm__ __volatile__ (
        "stp	x29, x30, [sp, #-80]!\n\t"
        "add	x29, sp, #0\n\t"
        ...
        "stp	x6, x7, [x1, #16]\n\t"
        "ldp	x29, x30, [sp], #0x50\n\t"
        : [r] "+r" (r), [p] "+r" (p), [qe_cached] "+r" (qe_cached)
        :
        : "memory", "x3", "x4", "x5", "x6", "x7", "x8", "x9", "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17", "x19", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28"
    );
        "ldp	x29, x30, [sp], #0x50\n\t"
...
void ge_sub(ge_p1p1 r, const ge_p3 p, const fe qe_cached)
{
    __asm__ __volatile__ (
        "stp	x29, x30, [sp, #-80]!\n\t"
        "add	x29, sp, #0\n\t"
...
void sc_muladd(byte* s, byte* a, byte* b, byte* c)
{
    __asm__ __volatile__ (
        /* Multiply */
        "ldp	x12, x13, [%x[a]]\n\t"
