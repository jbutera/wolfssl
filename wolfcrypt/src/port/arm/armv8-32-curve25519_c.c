...
void fe_invert(fe r_p, const fe a_p)
{
    ...
    "L_fe_invert8_%=: \n\t"
        ...
        : [r] "+r" (r), [a] "+r" (a)
        :
        : "memory", "lr", "r3", "r2", "r12", "r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11"
    );
}
...
void fe_pow22523(fe r_p, const fe a_p)
{
    ...
    "L_fe_pow22523_8_%=: \n\t"
        ...
        : [r] "+r" (r), [a] "+r" (a)
        :
        : "memory", "lr", "r4", "r2", "r3", "r12", "r5", "r6", "r7", "r8", "r9", "r10", "r11"
    );
}
...
void sc_muladd(byte* s_p, byte* a_p, byte* b_p, byte* c_p)
{
    register byte* s asm ("r0") = s_p;
    register byte* a asm ("r1") = a_p;
    register byte* b asm ("r2") = b_p;
    register byte* c asm ("r3") = c_p;
