...
enum {
    ...
    WOLFSSL_MODE_AUTO_RETRY           = 3,  /* wolfSSL default is to block with 
                                             * blocking io and auto retry */
    WOLFSSL_MODE_RELEASE_BUFFERS      = -1, /* For libwebsockets build.
                                             * No current use */
    ...
    WOLFX509_V_OK                                    = 0,
    WOLFX509_V_ERR_CRL_SIGNATURE_FAILURE             = 8,
    WOLFX509_V_ERR_CERT_HAS_EXPIRED                  = 10,
    WOLFX509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD    = 14,
    WOLFX509_V_ERR_CRL_HAS_EXPIRED                   = 15,
    WOLFX509_V_ERR_CERT_CHAIN_TOO_LONG               = 17,
    WOLFX509_V_ERR_UNABLE_TO_GET_ISSUER_CERT         = 18,
    WOLFX509_V_ERR_CERT_NOT_YET_VALID                = 19,
    WOLFX509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD    = 20,
    WOLFX509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD     = 22,
    WOLFX509_V_ERR_CERT_REVOKED                      = 23,
    WOLFX509_V_ERR_CERT_REJECTED                     = 24,
    /* Required for Nginx  */
    WOLFX509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT       = 25,
    WOLFX509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN         = 26,
    WOLFX509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY = 27,
    WOLFX509_V_ERR_CERT_UNTRUSTED                    = 28,
    WOLFX509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE   = 29,
    WOLFX509_V_ERR_SUBJECT_ISSUER_MISMATCH           = 30,
    /* additional WOLFX509_V_ERR_* enums not used in wolfSSL */
    WOLFX509_V_ERR_UNABLE_TO_GET_CRL,
    WOLFX509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE,
    WOLFX509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE,
    WOLFX509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY,
    WOLFX509_V_ERR_CERT_SIGNATURE_FAILURE,
    WOLFX509_V_ERR_CRL_NOT_YET_VALID,
    WOLFX509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD,
    WOLFX509_V_ERR_OUT_OF_MEM,
    WOLFX509_V_ERR_INVALID_CA,
    WOLFX509_V_ERR_PATH_LENGTH_EXCEEDED,
    WOLFX509_V_ERR_INVALID_PURPOSE,
    WOLFX509_V_ERR_AKID_SKID_MISMATCH,
    WOLFX509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH,
    WOLFX509_V_ERR_KEYUSAGE_NO_CERTSIGN,
    WOLFX509_V_ERR_UNABLE_TO_GET_CRL_ISSUER,
    WOLFX509_V_ERR_UNHANDLED_CRITICAL_EXTENSION,
    WOLFX509_V_ERR_KEYUSAGE_NO_CRL_SIGN,
    WOLFX509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION,
    WOLFX509_V_ERR_INVALID_NON_CA,
    WOLFX509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED,
    WOLFX509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE,
    WOLFX509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED,
    WOLFX509_V_ERR_INVALID_EXTENSION,
    WOLFX509_V_ERR_INVALID_POLICY_EXTENSION,
    WOLFX509_V_ERR_NO_EXPLICIT_POLICY,
    WOLFX509_V_ERR_UNNESTED_RESOURCE,
    WOLFX509_V_ERR_APPLICATION_VERIFICATION,
    WOLFX509_V_ERR_CRL_PATH_VALIDATION_ERROR,
    WOLFX509_V_ERR_DIFFERENT_CRL_SCOPE,
    WOLFX509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE,
    WOLFX509_V_ERR_PERMITTED_VIOLATION,
    WOLFX509_V_ERR_EXCLUDED_VIOLATION,
    WOLFX509_V_ERR_SUBTREE_MINMAX,
    WOLFX509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE,
    WOLFX509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX,
    WOLFX509_V_ERR_UNSUPPORTED_NAME_SYNTAX,

    WOLFX509_R_CERT_ALREADY_IN_HASH_TABLE,
